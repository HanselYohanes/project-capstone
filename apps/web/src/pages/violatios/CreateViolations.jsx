...
/**
 * CreateViolations — Form untuk mencatat pelanggaran zonasi baru secara manual.
 *
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok || !result.success) {
                throw new Error(result.error || `Gagal menyimpan pelanggaran. Status: ${response.status}`);
            }

            const savedName = result.data?.code || "Baru";
            resetForm();
            setSuccess(`Data pelanggaran "${savedName}" berhasil ditambahkan!`);
    ...
    return (
        <div className="ml-64 p-8 min-h-screen text-on-surface">
            ...
            <div className="flex items-end justify-between mb-8">
                <div>
                    <h1 className="font-headline text-3xl font-bold tracking-tight text-white">Catat Pelanggaran Baru</h1>
                    <p className="text-on-surface-variant text-sm mt-1">Tambahkan data pelanggaran zonasi secara manual ke dalam sistem.</p>
                </div>
            </div>
            ...
            <div className="glass-panel rounded-xl overflow-hidden max-w-4xl">
                <div className="px-8 py-5 border-b border-outline-variant/15 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-on-surface-variant text-xs">Pilih entitas target dan detail jenis pelanggaran</p>
                    </div>
                </div>
...
export default CreateViolations;
