...
const KPIGrid = ({ stats }) => {
  // Pecah datanya
  const { loading, pasar, total, violations, safe, compliance } = stats;
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 mb-8">
      ...
      <div className="bg-surface-container-high/70 backdrop-blur-md outline outline-1 outline-outline-variant/20 rounded-xl p-6 relative overflow-hidden group hover:outline-primary/30 transition-colors">
        ...
        <div className="mt-3 text-xs text-tertiary flex items-center gap-1">
          <span className="material-symbols-outlined text-[10px]">trending_down</span> -2% from last quarter
        </div>
      </div>
...
//           <span className="text-sm text-on-surface-variant font-medium leading-5 max-w-[70%]">
//             Total Pasar <br />
//             Tradisional
//           </span>
...
//           <span className="material-symbols-outlined text-tertiary/70">
//             verified
//           </span>
//         </div>
